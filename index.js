...
⚠️ Повышение не выдаётся автоматически без ручного одобрения старшего состава в планшете. Нажмите кнопку ниже, чтобы прикрепить доказательства.`)
            ...
            if (i.commandName === "interaction_panel") {
                const embed = new EmbedBuilder()
                    ...
                    .setImage("https://media.discordapp.net/attachments/1506711652483993686/1521245082546868336/29f7dc94-f64c-476f-8001-9bdb67a93a1c.png?ex=6a442163&is=6a42cfe3&hm=29cdd15e146bc2fa35943e6589f619e62137c9a4499abe59aa1c8577f4a82acf&=&format=webp&quality=lossless&width=1876&height=625")
                    .setDescription(
                ...
                await i.channel.send({ embeds: [embed], components: [interactionRow] });
