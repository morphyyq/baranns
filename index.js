...
⚠️ Повышение не выдаётся автоматически без ручного одобрения старшего состава в планшете. Нажмите кнопку ниже, чтобы прикрепить доказательства.`)
            ...
            if (i.commandName === "interaction_panel") {
                ...
                // Два embed одного цвета — визуально сливаются в одну карточку
                // Embed 1: только картинка (заполняет весь блок)
                const bannerEmbed = new EmbedBuilder()
                    .setImage(BANNER_URL)
                    .setColor("#2b2d31");

                // Embed 2: заголовок и описание
                const textEmbed = new EmbedBuilder()
                    ...
                    .setDescription(
                        ...
                        "\u{1F534} **Откат** \u2014 открыть гайд по оформлению отката.\n" +
