...
⚠️ Повышение не выдаётся автоматически без ручного одобрения старшего состава в планшете. Нажмите кнопку ниже, чтобы прикрепить доказательства.`)
            ...
            if (i.commandName === "interaction_panel") {
                ...
                // Загружаем баннер как файл — файлы рендерятся ВЫШЕ embed'ов в Discord
                const bannerFile = new AttachmentBuilder(BANNER_URL, { name: "banner.png" });
                ...
                // files рендерятся выше embed'ов — картинка окажется сверху
